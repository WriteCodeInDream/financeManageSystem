...
import pageElementOperate.relativeContractOperate.OtherContractListOperate;
import utils.GetMoney;

public class OtherContractListHandle {
    public OtherContractListOperate lco;
    public OtherContractListHandle(BaseDriver baseDriver){
        this.lco = new OtherContractListOperate(baseDriver);
    }
